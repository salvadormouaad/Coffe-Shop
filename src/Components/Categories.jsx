...
export default function Categories() {
  return (
    <div className="container max-sm:mx-0  lg:mx-auto lg:px-18 lg:py-8">
      <h1 className="font-Lonely-Coffee text-center text-4xl mb-8 md:mt-15">Top Categories</h1>
      <Slider {...sliderSettings}>
        {backgrounds.map((bg, index) => (
          <div key={index} className="px-2">
            ...
            >
              <button className="bg-[#C37841] max-sm:mx-7 max-sm:p-1 max-sm:my-50 lg:ml-50 lg:mt-50 text-white  hover:bg-[#2D1801] lg:px-10  lg:py-2 rounded-full text-lg font-semibold transition-colors duration-300 md:p-2 md:ml-30 md:mt-50 ">
                Shop now
              </button>
            </div>
          </div>
